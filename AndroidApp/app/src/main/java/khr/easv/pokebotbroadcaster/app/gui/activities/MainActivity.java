...
public class MainActivity extends    ActionBarActivity
                          implements ILogEntryClickedListener,
    ...
    public static final String DEVICE_ADDRESS = "00:16:53:1A:D8:44"; // Bobby John's MAC address
    ...
    // Format options for displaying decimal numbers on the UI.
    ...
    /*
     * When the orientation changes TRY to update the UI texts showing the orientation values, and
     * save the _pith in a _global var.
     */
    @Override
    ...
    /*
     * When the PID controller notifies it's listeners about an update, this method gets called and
     * tries to parse the packet sent from the BalanceManager to display it on the UI then try to
     * initiate a bluetooth SEND to the connected device.
     */
    @Override
    ...
    /*
     * Quick bit-shifting method to check for the packet generated by the BalanceManager.
     */
