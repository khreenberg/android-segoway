...
public class LogListAdapter extends ArrayAdapter<LogEntry>{
    ...
    private View inflateView() {
        ...
        return li.inflate(R.layout.list_item_log_entry, null);
    }
    ...
    private int getBackgroundColorId(LogEntry entry) {
        int colorID;
        switch (entry.getTag()){
            case DEBUG:     colorID = R.color.LOG_ENTRY_DEBUG;      break;
            case INFO:      colorID  = R.color.LOG_ENTRY_INFO;      break;
            case ERROR:     colorID = R.color.LOG_ENTRY_ERROR;      break;
            case WARNING:   colorID = R.color.LOG_ENTRY_WARNING;    break;
            default:
